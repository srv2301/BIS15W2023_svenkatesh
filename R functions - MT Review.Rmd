...
#Use c bind for doing an operation on more than one value
```{r}
...
my_new_numbers #can generate a vector number sequence by concatonate with round brackets and : for a range of numbers
```
