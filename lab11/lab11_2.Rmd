...
p2 <- homerange %>% 
  ...
  geom_point()
p2+ scale_color_brewer(palette="PiYG") #for scatterplots use the scale_color_brewer function
```
...
ecosphere %>% 
  ggplot(aes(x=log10_mass))+
  geom_density()+ 
  facet_grid(life_expectancy~habitat) #(1 = rows~ 2=columns)
```
