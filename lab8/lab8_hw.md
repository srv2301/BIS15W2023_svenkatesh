...
```
## [1] "/Users/srinidhi/Desktop/BIS15W2023_svenkatesh"
```
...
```
Yes, they are tidy since each variable has its own column. It is in the long format.
...
```r
sydneybeaches_new <- sydneybeaches_long_mean %>% 
...
```
The South Marouba Rockpool beach was the most polluted beach in 2018.
